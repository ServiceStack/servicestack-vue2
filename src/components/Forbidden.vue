...
export class Forbidden extends Vue {
    ...
    protected get query() {
        return ((this as any).$route && (this as any).$route.query) || {};
    }

    protected get usePath() {
        return this.path || this.query.path as string || null;
    }

    protected get useRole() {
        return this.role || this.query.role as string || null;
    }

    protected get usePermission() {
        return this.permission || this.query.permission as string || null;
    }
}
